...
* **figure** The completed product, consisting of one or more graphs and
...
```{r chunk1, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk1', type = 'figure'),": A simple x-y scatter plot.")}
...
```{r chunk2, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk2', type = 'figure'),": Scatter plot variations.")}
xyPlot(X, Y, 
...
```{r chunk3, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk3', type = 'figure'),": Scatter plot label variations.")}
...
```{r chunk4, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk4', type = 'figure'),": Example of multiple plots in a graph. ")}
...
Sometimes, complete figures need multiple graphs instead of multiple plots within a graph. In that case, or when the graph area needs to be changed from the default, two additional functions (`setLayout` and `setGraph`) are needed. The `setLayout` function can be used to
set up a grid of graphs and the `setGraph` functions sets up each individual graph. The graphs set up by `setLayout} can share axes or stand alone.

```{r chunk5, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk5', type = 'figure')), fig.height=4, eval=FALSE}
...
```{r chunk6, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk6', type = 'figure'),": Figure with multiple graphs and an explanation.")}
...
```{r chunk7, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk7', type = 'figure'),": Figure of multiple graphs with a shared x-axis. "), fig.width=4, eval=FALSE}
...
```{r chunk8, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk8', type = 'figure'),": Graph showing axis ticks on top of shaded area."),fig.width=5}
# Set the layout for 2 graphs in one column with shared x-axes
