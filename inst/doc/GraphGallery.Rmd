...
`r fig_nums('chunk1',"A graph with error bars.")`
...
`r fig_nums('chunk2',"A biplot from a principal component analysis.")`
...
`r fig_nums('chunk3',"A scaleless graph also showing Stiff diagrams.")`
...
`r fig_nums('chunk4',"An example area graph.")`
...
```{r  chunk5, eval=FALSE, fig.height=7,fig.width=7}
...
`r fig_nums('chunk5',"A contour plot with filled contours.")`
...
`r fig_nums('chunk6',"Selected correlograms.")`
...
`r fig_nums('chunk7',"A surface plot.")`
...
`r fig_nums('chunk8',"A graph showing the report from a simple linear regression.")`
...
`r fig_nums('chunk9',"The dendrogram of the example cluster analysis.")`
