...
Figures `r figr("thirteenChunk")` and `r figr("fourteenChunk")` show the water year format for 1 and 5 water years. The format changes after a time span of 2 water years. Minor ticks are drawn only in figure `r figr("thirteenChunk")`.
