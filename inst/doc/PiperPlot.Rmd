...
```{r chunk1, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk1'),": The Piper diagram."), fig.height=7, fig.width=7}
...
```{r chunk2, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk2'),": A customized Piper diagram."), fig.height=7, fig.width=7}
...
```{r chunk3, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk3'),": A very simple ternary diagram."), fig.height=3.5, fig.width=3.5} 
# Accept all defaults
...
```{r chunk4, anchor="figure", fig.cap=paste0("**Figure ** ",figr('chunk4'),": The Stiff diagram."), eval=FALSE} 
